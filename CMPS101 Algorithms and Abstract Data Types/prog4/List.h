...
void sortedInsert(ListRef L, int data); //insert new element according to data
//Post: !isEmpty()
...
// Post: !isEmpty()
void enqueue(ListRef Q, int data); //insertion treating list as queue
...
// Pre: !offEnd(); Post: !isEmpty(), !offEnd()
int dequeue(ListRef Q); //treats list as queue, returns last element
